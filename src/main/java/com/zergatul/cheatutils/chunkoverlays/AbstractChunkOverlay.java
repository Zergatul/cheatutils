...
public abstract class AbstractChunkOverlay {
    ...
    public final void onChunkLoaded(Dimension dimension, WorldChunk chunk) {
        if (!isEnabled()) {
            return;
        }
    ...
    protected abstract boolean drawChunk(Dimension dimension, Map<SegmentPos, Segment> segments, WorldChunk chunk);
