...
public abstract class EspConfigBase implements Sanitizable {
    ...
    public void sanitize() {
        tracerWidth = MathUtils.clamp(tracerWidth, 0.5, 100, 1);
        boundingBoxWidth = MathUtils.clamp(boundingBoxWidth, 0.5, 100, 1);
    }
