...
public class RenderingContext {
    ...
    public void extract(GuiGraphicsExtractor graphics, Element element, int x, int y, HorizontalAlign hAlign, VerticalAlign vAlign) {
        extractToBuffers(element, x, y, hAlign, vAlign);
        ((GuiGraphicsExtractorExtension) graphics).addRenderBuffers_CU(buffers);
    }
