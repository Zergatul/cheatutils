...
public class ItemRenderHelper {
    ...
    public static void renderItem(LivingEntity entity, ItemStack itemStack, int x, int y) {
        mc.getItemRenderer().renderAndDecorateItem(entity, itemStack, x, y, 123);
    ...
    public static void renderItem(LivingEntity entity, ItemStack itemStack, double x, double y, double z) {
        ...
        if (itemStack.getCount() != 1) {
            ...
            posestack2.translate(0.0F, 0.0F, itemRenderer.blitOffset + 200.0F);
            ...
            mc.font.drawInBatch(s, (float)(x + 19 - 2 - mc.font.width(s)), (float)(y + 6 + 3), 16777215, true, posestack2.last().pose(), multibuffersource$buffersource2, false, 0, 15728880);
