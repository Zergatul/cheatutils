...
public class ApiDocsGenerator {
    ...
    public static List<String> generateLines(boolean includeScriptTypeDescriptions) {
        ...
        lines.add(String.format("// Minecraft Version: %s (%s)", SharedConstants.getCurrentVersion().name(), environment.getLoaderName()));
        lines.add(String.format("// CheatUtils Version: %s", environment.getModVersion()));
