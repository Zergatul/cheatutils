...
public class EventsApi {
    ...
    @MethodDescription("""
            ...
            """)
    @HelpText("Triggers every tick while the game handles in-world key bindings.")
    ...
    @MethodDescription("""
            ...
            """)
    @HelpText("Runs at the end of each client tick while the player is in a world.")
    @ApiVisibility(ApiType.EVENTS)
    ...
    @MethodDescription("""
            ...
            """)
    @HelpText("Runs at the end of each client tick while no world is loaded.")
    @ApiVisibility(ApiType.EVENTS)
