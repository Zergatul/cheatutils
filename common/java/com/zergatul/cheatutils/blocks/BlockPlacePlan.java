...
public class BlockPlacePlan {
    ...
    public BlockPlacePlan(BlockPlacerConfig config, BlockPos destination, BlockPos neighbour, Direction direction, Vec3 target) {
        this(config, destination, neighbour, direction, target, null);
    }

    public BlockPlacePlan(BlockPlacerConfig config, BlockPos destination, BlockPos neighbour, Direction direction, Vec3 target, Rotation rotation) {
