...
module({
  ...
  onClick() {
    window.open(
      "https://github.com/Zergatul/java-scripting-language/blob/c096c28b5c2b849d0c9b39f5592ea2b6244ed8b0/README.md",
      "_blank",
    );
  },
});
module({
  ...
  onClick() {
    window.open(
      "https://github.com/Zergatul/cheatutils-examples/tree/master/v3",
      "_blank",
    );
  },
});
...
module({
  ...
  onClick() {
    window.open(
      "https://www.youtube.com/playlist?list=PLG9SPA0O8HLSyHpxp-Y66ktVIAjQwWWk_",
      "_blank",
    );
  },
});
